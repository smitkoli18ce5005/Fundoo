            ...
            <div class="signup-inner-div">
                <div class="signup-div">
                    <div class="form">
                        ...
                        <h1 class="heading-h1">Create your Google Account</h1>
                        ...
                        <div class="input-pair-2">
                            <div class="input-holder">
                                ...
                                <label alt='User Name' placeholder='User Name'></label>
                            </div>
                            <small class="small-text-1">You can use letters, numbers and periods</small>
                        </div>
                        ...
                        <div class="password-div">
                            ...
                            <small class="small-text-1">Use 8 or more characters with a mix of letters, numbers &amp; symbols</small>
                        </div>
                ...
                <div class="logo-div">
                    <figure>
                        ...
                        <figcaption class="small-text-3">One account. All of Google working for you.</figcaption>
                    </figure> 
                </div>
            </div>
        </div>
